...
spawn(function() 
    ...
    wait(.24)
    require(game.ReplicatedStorage.Notification).new("<Color=Pink>Tham gia discord để cập nhật thông tin mới nhất nhé<Color=/>"):Display()
    wait(.29)
...
local Window = OrionLib:MakeWindow({Name = "Finn hub", HidePremium = false, IntroText = "Finn hub⚜️", SaveConfig = true, ConfigFolder = "FinnHub"})
...
W:AddLabel("Finn")
W:AddLabel("Finn hub")
W:AddLabel("Discord https://discord.gg/WcgXVCKyap")
local Section = W:AddSection({
    Name = "Status"
})
